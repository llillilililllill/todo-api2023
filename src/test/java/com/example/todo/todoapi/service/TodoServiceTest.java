...
class TodoServiceTest {
    ...
    @Test
    @DisplayName("새로운 할 일을 등록하면 생성되는 리스트 할 일이 4개 들어있어야 한다.")
    void createTest() {
        //givne
    ...
    @Test
    @DisplayName("2번째 할 일의 제목을 수정수정으로 수정하고 할일 완료처리를 해야한다.")
    void updateTest() {
        // given
    ...
    void deleteTest() {
        ...
        TodoListResponseDTO deleteDTO = todoService.delete(targetTodo.getId());
        //then
